...
import {updateDeviceQuantity, deleteDeviceRoom, getDevices, addDeviceToRoom } from "@/services/deviceRoomService";
  ...
  const handleDeleteDevice = async () => {
    ...
    try {
      const deviceToDeleteData: DeviceRoom = {
        ...
        newQuantity: 1 // Not needed for deletion but included for consistency
      };
